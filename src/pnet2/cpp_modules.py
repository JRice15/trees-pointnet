...
PNET2_DIR = os.path.dirname(os.path.abspath(__file__))

sampling_module=tf.load_op_library(f'{PNET2_DIR}/tf_ops/sampling/tf_sampling_so.so')
grouping_module=tf.load_op_library(f'{PNET2_DIR}/tf_ops/grouping/tf_grouping_so.so')
interpolate_module=tf.load_op_library(f'{PNET2_DIR}/tf_ops/3d_interpolation/tf_interpolate_so.so')
